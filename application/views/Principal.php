<div class="container " style="padding-top: 10px;margin-top:20px">
    ...
    <div class="bg-white">
        ...
        <?php if (!isset($_REQUEST['politica-cookies']) && !isset($_COOKIE['politica'])): ?>
            ...
            <div class="cookies bg-light" style="margin-top:100px;opacity:0.9">
                <p style="color:black;margin-left:320px"><b>El administrador en esta web está configurado como:<p style="margin-left:500px;color:red">admin</p> <p style="color:black;margin-left:500px">BDD:<p style="margin-left:500px;color:red">loteria</p></b></p></p>
